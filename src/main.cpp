...
int main() {
  ...
  h.onMessage(
          [&car_velocity, &max_velocity, &velocity_increment, &LEFT_LANE, &MID_LANE, &RIGHT_LANE, &TIME_INC, &SAFE_DISTANCE, &lane, &map_waypoints_x, &map_waypoints_y, &map_waypoints_s,
              ...
              if (length && length > 2 && data[0] == '4' && data[1] == '2') {
                ...
                if (s != "") {
                  ...
                  if (event == "telemetry") {
                    ...
                    vector<double> wp30 = getXY(car_s + 30, 2 + lane * 4, map_waypoints_s, map_waypoints_x,
                                                map_waypoints_y);

                    vector<double> wp60 = getXY(car_s + 60, 2 + lane * 4, map_waypoints_s, map_waypoints_x,
                                                map_waypoints_y);
                    vector<double> wp90 = getXY(car_s + 90, 2 + lane * 4, map_waypoints_s, map_waypoints_x,
                                                map_waypoints_y);
